            ...
            <CardItem>
                <View style={{flex:1, flexDirection: 'row'}}>
                  <View style={{paddingRight: 30}}>
                    <Text style={{fontSize: 15, color: colors.lightGray}}>Distance</Text>
                    <Text>0.36 km</Text>
                  </View>
                  <View style={{paddingRight: 30}}>
                    <Text style={{fontSize: 15, color: colors.lightGray}}>Pace</Text>
                    <Text>55:51 /km</Text>
                  </View>
                  <View style={{paddingRight: 30}}>
                    <Text style={{fontSize: 15, color: colors.lightGray}}>Time</Text>
                    <Text>20m 28s</Text>
                  </View>
                </View>
            </CardItem>
