...
export default class CardComponent extends Component {
  ...
  changeStatus = () => {
    this.setState({isActiveStatus: !this.state.isActiveStatus})
  }
  render() {
    return (
        <Content>
          <Card>
            ...
            <CardItem>
              <Left>
                <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}} onPress={() => this.changeStatus()}>
                  <Icon name="heart" size={22} color={this.state.isActiveStatus? colors.primaryColor: colors.darkGray}/>
                  <Text style={{fontSize: 11, marginLeft: 5}}>5000 Likes</Text>
                </TouchableOpacity>
              </Left>
              <Body style={{alignItems: 'flex-start'}}>
                <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}} onPress={() => this.changeStatus()}>
                  <Icon name="eye" size={22} color={this.state.isActiveStatus? colors.primaryColor: colors.darkGray}/>
                  <Text style={{fontSize: 11, marginLeft: 5}}>3000 Comments</Text>
                </TouchableOpacity>
              </Body>
              <Right>
                <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}} onPress={() => this.changeStatus()}>
                  <Icon name="share" size={22} color={this.state.isActiveStatus? colors.primaryColor: colors.darkGray}/>
