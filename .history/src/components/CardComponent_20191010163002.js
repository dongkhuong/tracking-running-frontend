            ...
            <CardItem>
              <Left>
                <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  <Text style={{fontSize: 12, marginLeft: 5}}>5000 Likes</Text>
                </TouchableOpacity>
              </Left>
              <Body style={{alignItems: 'flex-start'}}>
                <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}}>
                  <Icon name="eye" size={25} color={colors.darkGray}/>
                  <Text style={{fontSize: 12, marginLeft: 5}}>3000 Comments</Text>
                </TouchableOpacity>
              </Body>
              <Right>
                <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center'}}>
                  <Icon name="share" size={25} color={colors.darkGray}/>
                  <Text style={{fontSize: 12, marginLeft: 5}}>156 Shares</Text>
                </TouchableOpacity>
              </Right>
            </CardItem>
          </Card>
