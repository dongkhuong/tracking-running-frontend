            ...
            <Container>
                <Content>
                    <Card>
                        <CardItem>
                            <Left>
                                <Thumbnail source={require('../../../assets/images/logoImage.jpg')} style={{ width: metrics.DEVICE_WIDTH*0.2, height: metrics.DEVICE_WIDTH*0.2, borderRadius: metrics.DEVICE_WIDTH*0.5}}/>
