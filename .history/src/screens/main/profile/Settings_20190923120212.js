            ...
            <Container>
                <ScrollView>
                    <Content>
                        <Card>
                            <CardItem>
                                <TextPage color={colors.black} fontSize={15} fontWeight={'bold'}>PERSONAL SETTINGS</TextPage>
                            </CardItem>
                            <CardItem>
                                <Left>
                                    <Icon name='home' />
                                    <TouchableOpacity style={{marginLeft:10}}>
                                        <TextPage color={colors.black} fontSize={13} fontWeight={'normal'}>Edit Profile</TextPage>
                                    </TouchableOpacity>
                                </Left>
                                {/* <Left> */}
