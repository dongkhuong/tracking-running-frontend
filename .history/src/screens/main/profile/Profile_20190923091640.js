                                ...
                                <TouchableOpacity>
                                    <Left>
                                        ...
                                        <TouchableOpacity style={{marginLeft:10}}>
                                            <TextPage color={colors.black} fontSize={11} fontWeight={'bold'}>0 Friends</TextPage>
                                            <TextPage color={colors.darkGray} fontSize={11} fontWeight={'normal'}>Connect with the fitness community</TextPage>
                                        </TouchableOpacity>
                                    </Left>
                                </TouchableOpacity>
                            </CardItem>
