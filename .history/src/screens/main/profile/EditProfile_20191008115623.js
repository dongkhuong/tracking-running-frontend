                        ...
                        <CardItem>
                            <Left>
                                ...
                                <View style={{flexDirection: 'column', flex: 1}}>
                                    <Input label="FIRST NAME" labelStyle={{fontSize:13}} inputContainerStyle={{height:20, borderBottomWidth: 1, marginBottom: 10, paddingBottom:5}} inputStyle={{fontSize:15}}/>
