                    ...
                    <Card>
                        ...
                        <CardItem>
                            <View style={{flexDirection: 'column', flex: 1}}>
                                ...
                                />
                                <TouchableOpacity onPress={() => this.showDateTimePicker()} style={{ paddingBottom: 10, marginTop: 10, paddingHorizontal: 10}}>
                                    <View style={{flex: 1, flexDirection: 'row', borderBottomWidth: 1, paddingBottom: 10,}}>
                                        <Left>
