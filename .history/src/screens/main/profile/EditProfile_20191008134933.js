                    ...
                    <Card>
                        ...
                        <CardItem>
                            <View style={{flexDirection: 'column', flex: 1}}>
                                ...
                                />
                                <TouchableOpacity onPress={() => this.showDateTimePicker()} style={{flexDirection: 'row', borderBottomWidth: 1, paddingBottom: 10, borderBottomColor: colors.darkGray, marginTop: 10}}>
                                    <Left>
