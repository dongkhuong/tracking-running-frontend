...
import { Constant, httpRequest } from '../../../../common'
class Settings extends Component {
    ...
    _signOutAsync = async () => {
        // httpRequest.get('/displayAllUsers').then(response => console.log(response))
        // if(asyncStorage){
        //     await axios.post(common.rootAPI+'/displayAllUsers', {headers: {Authorization: `Bearer ${asyncStorage}`}}).then(response => console.log(response))
            // await AsyncStorage.clear();
        // }
        // this.props.navigation.navigate('AuthLoading')
        const asyncStorage = await AsyncStorage.getItem("token")
               // if(asyncStorage){
        await axios.gets(Constant.rootAPI+'/displayAllUsers', {headers: {'Authorization': `Bearer ${asyncStorage}`}}).then(response => console.log(response))
        // if(asyncStorage){
