                    ...
                    <Card>
                        ...
                        <CardItem>
                            <View style={{flexDirection: 'column', flex: 1}}>
                                ...
                                data={data}
                                value={'Please Choose'}
                                containerStyle={{paddingHorizontal:10, borderBottomColor: 'red', fontWeight: 'bold', borderBottomWidth:1}}
                                baseColor={colors.darkGray}
                                />
                                <TouchableOpacity onPress={() => this.showDateTimePicker()} style={{flexDirection: 'row', paddingBottom: 10, marginTop: 10, paddingHorizontal: 10}}>
                                    <Left>
