...
import { Card, Container, Content, CardItem, Thumbnail, Body, Left } from 'native-base'
                        ...
                        <Card>
                            <CardItem>
                                <Body style={{alignItems: 'center'}}>
                                    ...
                                    <TextPage marginTop={5} color={colors.black} fontSize={10} fontWeight={'normal'}>Runtastic user since 15 thg 8, 2019</TextPage>
                                </Body>
                            </CardItem>
                        </Card>
                        <Card>
