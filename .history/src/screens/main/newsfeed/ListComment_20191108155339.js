            ...
            <ScrollView>
                ...
                {this.state.showTextArea ? 
                    (<View style={styles.commentAreaText}>
                        ...
                        />
                        <TouchableOpacity style={styles.submitButtonComment} onPress={() => this.setState({showCommentButton: true})}>
                            <Icon name="close" color={colors.white}/>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.closeButtonComment} onPress={() => this.setState({showCommentButton: true})}>
