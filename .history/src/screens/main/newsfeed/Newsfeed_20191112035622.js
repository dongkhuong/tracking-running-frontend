    ...
    async countLikes(post_id){
      try{
        ...
        if(countLikes.data.business_code == 1){
          // await this.setState({sumOfLikes: countLikes.data.sumOfLikes})
          return countLikes.data.sumOfLikes
                              ...
                              <CardItem>
                                <Left>
                                  ...
                                  onPress={() => this.actionLike(item.id)}>
                                    ...
                                    <Text style={{fontSize: 11, marginLeft: 5}}>{async () => await this.countLikes(item.id)} Like</Text>
