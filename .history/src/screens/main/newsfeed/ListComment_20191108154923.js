    ...
    render() {
        return (
            ...
            <ScrollView>
                ...
                <TouchableOpacity style={styles.commentCircleButton} onPress={() => this.setState({showTextArea: true})}>
                ...
                {this.state.showTextArea ? 
                    (<View style={styles.commentAreaText}>
                        ...
                        />
                        <TouchableOpacity style={{backgroundColor: colors.primaryColor, width: 30, height: 30, position: 'absolute', alignItems: 'center', justifyContent: 'center', borderRadius: 15, right: 10}}>
                            <Icon name="close" color={colors.white}/>
                        </TouchableOpacity>
                        <TouchableOpacity style={{backgroundColor: colors.primaryColor, width: 30, height: 30, position: 'absolute', alignItems: 'center', justifyContent: 'center', borderRadius: 15, right: 50}}>
