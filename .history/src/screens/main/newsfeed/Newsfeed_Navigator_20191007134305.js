...
export default NewsFeed_Navigator = createAppContainer(createStackNavigator({
    NewsFeed: {
        ...
        navigationOptions: ({navigation}) => ({
            header: 
            <Header
            leftComponent={{ text: 'NewsFeed', style: {width: metrics.DEVICE_WIDTH*0.3, fontSize: fonts.fontTitleHeader, color: colors.white, fontFamily: 'Montserrat-Regular'}}}
    ...
    AddFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            centerComponent={{ text: 'Add Friend', style: {fontSize: fonts.fontTitleHeader, color: colors.white, fontFamily: 'Montserrat-Regular'}}}
    ...
    SearchFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            <Header
            leftComponent={<GoBackButton name="arrow-back" color={colors.white} navigation={navigation}/>}
            centerComponent={{ text: 'Search Friend', style: {fontSize: fonts.fontTitleHeader, color: colors.white, fontFamily: 'Montserrat-Regular'}}}
