                            ...
                            <Card>
                              <CardItem style={{paddingBottom: 0}}>
                                ...
                                {/* source={require('../../../assets/images/backgroundImage.jpg')} */}
                                  <Thumbnail  style={{marginRight: 10}} source={{uri : item.user.avatar != null ? item.user.avatar : "https://cdn0.iconfinder.com/data/icons/people-lifestyle/100/Run-01-512.png" }}/>
                                  <Body>
