                            ...
                            <Card>
                              <CardItem style={{paddingBottom: 0}}>
                                ...
                                {/* source={require('../../../assets/images/backgroundImage.jpg')} */}
                                  <Thumbnail  style={{marginRight: 10}} source={{uri : item.user.avatar != null ? item.user.avatar : "https://fbcd.co/images/products/54e960017be066cdc91e7b9858167745_resize.jpg" }}/>
                                  <Body>
