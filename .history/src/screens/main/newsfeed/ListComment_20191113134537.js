                    ...
                    <CardItem style={{borderBottomWidth: 1, borderBottomColor: colors.gray}}>
                        <View style={{width: metrics.DEVICE_WIDTH*0.9}}>
                            <TouchableOpacity style={{width: '100%', flexDirection: 'row', alignItems: 'center'}} onPress={() => this.props.navigation.navigate('FollowFriend',{userLikes: this.state.userLikes})}>
                                <Thumbnail style={{marginRight:20, width: 17, height: 17}} square source={require('../../../assets/images/icons/like.png')}/>
                                <Text style={{fontSize: 20, marginRight:20}}>{this.state.sumOfLikes}</Text>
                                <View style={{flexDirection: 'row'}}>
                                    <Thumbnail  style={{marginRight:5, width: 17, height: 17}} source={{uri:"https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto/gigs/21760012/original/d4c0c142f91f012c9a8a9c9aeef3bac28036f15b/create-your-cartoon-style-flat-avatar-or-icon.jpg"}}/>
                                    <Thumbnail  style={{marginRight:5, width: 17, height: 17}} source={{uri:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3zROcvE9mwFbmqhgz2ed34AjqkR_mENY9SAgeGbx9I4cH7S0LPg&s"}}/>
