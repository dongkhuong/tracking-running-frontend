        ...
        return (
            <ScrollView style={{flex: 1}}>
                <Card style={{paddingRight:20}}>
                    ...
                    <CardItem style={{paddingRight:10, borderBottomWidth: 1}}>
                        <View style={{flexDirection: 'row', flex: 1, }}>
                            ...
                            <View style={{flexDirection: 'column'}}>
                                ...
                                <Text>Hello, My name is Dong Khuong,kjhqwheqwheoihasbhcfjuibgdhasdoihqwoiheqoiwheqoiwheoqiwhjuahsbug</Text>
                            </View>
                        </View>
                    </CardItem>
                </Card>
