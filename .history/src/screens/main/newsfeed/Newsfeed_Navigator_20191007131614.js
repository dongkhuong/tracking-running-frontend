...
export default NewsFeed_Navigator = createAppContainer(createStackNavigator({
    ...
    AddFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            centerComponent={{ text: 'Add Friend', style: { color: colors.white, fontFamily: 'Mansalva-Regular'} }}
    ...
    SearchFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            <Header
            leftComponent={<GoBackButton name="arrow-back" color={colors.white} navigation={navigation}/>}
            centerComponent={{ text: 'Search Friend', style: { color: colors.white, fontFamily: 'Mansalva-Regular'}}}
