        ...
        return (
            ...
            <ScrollView>
                ...
                <View style={styles.commentAreaText}>
                    ...
                    />
                    <TouchableOpacity style={{backgroundColor: colors.primaryColor, width: 40, height: 40, position: 'absolute', alignItems: 'center', justifyContent: 'center', borderRadius: 20, right: 5}}>
