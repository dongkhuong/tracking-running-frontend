...
export default NewsFeed_Navigator = createAppContainer(createStackNavigator({
    NewsFeed: {
        ...
        navigationOptions: ({navigation}) => ({
            header: 
            <Header
            leftComponent={{ text: 'NewsFeed', style: {color: colors.white, fontFamily: 'Mansalva-Regular'}}}
    ...
    AddFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            centerComponent={{ text: 'Add Friend', style: {fontSize:20, color: colors.white, fontFamily: 'Mansalva-Regular'} }}
