...
export default NewsFeed_Navigator = createAppContainer(createStackNavigator({
    ...
    AddFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            centerComponent={{ text: 'Add Friend', style: {fontSize: fonts.fontTitleHeader, color: colors.white, fontFamily: 'OpenSans-Regular'}}}
    ...
    SearchFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            <Header
            leftComponent={<GoBackButton name="arrow-back" color={colors.white} navigation={navigation}/>}
            centerComponent={{ text: 'Search Friend', style: {fontSize: fonts.fontTitleHeader, color: colors.white, fontFamily: 'OpenSans-Regular'}}}
