                    ...
                    refreshControl={
                        ...
                        {this.state.data.map((item, index) =>(
                            ...
                            <Card>
                              ...
                              <CardItem>
                                <View style={{flex: 1, flexDirection: 'row', borderTopWidth: 1, borderBottomWidth: 1, paddingVertical: 5, borderColor: colors.darkGray}}>
                                  <View style={{flex:1, alignItems: 'center', borderRightWidth: 1, borderColor: colors.darkGray}}>
                                    <TouchableOpacity 
