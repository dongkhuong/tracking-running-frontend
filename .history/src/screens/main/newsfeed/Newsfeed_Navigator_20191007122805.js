...
export default NewsFeed_Navigator = createAppContainer(createStackNavigator({
    NewsFeed: {
        ...
        navigationOptions: ({navigation}) => ({
            header: 
            <Header
            leftComponent={{ text: 'MY TITLE', style: { color: colors.white, fontFamily: 'Indie Flower' } }}
            ...
            containerStyle={{paddingTop: 0, height: metrics.DEVICE_WIDTH*0.1}}
    ...
    AddFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            centerComponent={{ text: 'Add Friend', style: { color: colors.white } }}
            rightComponent={<RightTopButton nameRedirect="SearchFriend" name="search" color={colors.white} navigation={navigation}/>}
            containerStyle={{paddingTop: 0, height: metrics.DEVICE_WIDTH*0.15}}
            backgroundColor={colors.primaryColor}
            />
        })
    },
    SearchFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            <Header
            leftComponent={<GoBackButton name="arrow-back" color={colors.white} navigation={navigation}/>}
            centerComponent={{ text: 'Search Friend', style: { color: colors.white } }}
