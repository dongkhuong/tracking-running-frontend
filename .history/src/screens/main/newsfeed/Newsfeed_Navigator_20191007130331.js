...
export default NewsFeed_Navigator = createAppContainer(createStackNavigator({
    NewsFeed: {
        ...
        navigationOptions: ({navigation}) => ({
            header: 
            <Header
            leftComponent={{ text: 'NewsFeed', style: {color: colors.white, fontFamily: 'Montserrat-Regular'}}}
    ...
    AddFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            centerComponent={{ text: 'Add Friend', style: { color: colors.white, fontFamily: 'Montsserrat-Regular'} }}
    ...
    SearchFriend: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            <Header
            leftComponent={<GoBackButton name="arrow-back" color={colors.white} navigation={navigation}/>}
            centerComponent={{ text: 'Search Friend', style: { color: colors.white, fontFamily: 'Montsserrat-Regular'}}}
