                        ...
                        <View style={{width: metrics.DEVICE_WIDTH*0.9}}>
                            <TouchableOpacity style={{width: '100%', flexDirection: 'row', alignItems: 'center'}} onPress={() => this.props.navigation.navigate('FollowFriend',{userLikes: this.state.userLikes})}>
                                ...
                                <View style={{flexDirection: 'row'}}>
                                    <Thumbnail style={{position: 'absolute', right:40}} small source={{uri:"https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto/gigs/21760012/original/d4c0c142f91f012c9a8a9c9aeef3bac28036f15b/create-your-cartoon-style-flat-avatar-or-icon.jpg"}}/>
                                    <Thumbnail style={{position: 'absolute', right:40}} small source={{uri:"https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto/gigs/21760012/original/d4c0c142f91f012c9a8a9c9aeef3bac28036f15b/create-your-cartoon-style-flat-avatar-or-icon.jpg"}}/>
                                    <Thumbnail style={{position: 'absolute', right:40}} small source={{uri:"https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto/gigs/21760012/original/d4c0c142f91f012c9a8a9c9aeef3bac28036f15b/create-your-cartoon-style-flat-avatar-or-icon.jpg"}}/>
                                </View>
