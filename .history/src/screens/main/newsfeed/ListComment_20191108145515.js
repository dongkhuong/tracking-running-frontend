        ...
        return (
            <ScrollView style={{flex: 1}}>
                <Card>
                    ...
                    <TouchableOpacity style={{position: 'absolute', borderRadius: 25, width: 50, height: 50, alignItems: 'center', justifyContent: 'center', right: 30, left: 30, backgroundColor: 'blue'}}>
                        <Icon name="add"/>
                    </TouchableOpacity>
                </Card>
            </ScrollView>
