                ...
                <Card>
                    ...
                    <CardItem style={{borderBottomWidth: 1, borderBottomColor: colors.gray}}>
                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                            ...
                            <View>
                                <Text style={{color: colors.darkGray, fontSize: 12, marginBottom: 5, alignItems: 'center'}}>{item.user.firstname + ' ' + item.user.lastname} . {this.getFormatDay(item.created_at)}</Text>
