        ...
        return (
            ...
            <ScrollView>
                ...
                <View style={styles.commentAreaText}>
                    ...
                    <TouchableOpacity style={{backgroundColor: colors.primaryColor, width: 30, height: 30, position: 'absolute', alignItems: 'center', justifyContent: 'center', borderRadius: 15, right: 45}}>
                        <Icon name="checkmark" color={colors.white}/>
                    </TouchableOpacity>
                </View>
            </View>
