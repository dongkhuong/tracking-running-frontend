...
class NewsFeed extends Component {
    ...
    async checkLike(id){
      try{
        ...
        if(likes.data.business_code == 1){
          this.setState({arrLikes: likes.data.data.data})
          console.log(this.state.arrLikes)
        } else if (like.data.business_code == 0) {
    ...
    async componentDidMount () {
        ...
        await console.log(this.containsObject({post_id: "55f2d1f00e874492a667253312bad7c3"}, this.state.arrLikes))
    }
    render() {
