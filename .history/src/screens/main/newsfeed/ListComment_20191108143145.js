                    ...
                    <CardItem style={{marginRight:10, borderBottomWidth: 1}}>
                        <View style={{flexDirection: 'row', flex: 1, }}>
                            ...
                            <View style={{flexDirection: 'column', paddingRight: 10}}>
                                ...
                                <Text style={{marginRight:10}}>NativeBase Toast can be used to display quick warning or error messages. For Toast to work, you need to wrap your topmost component inside <Root> from native-base.</Text>
                            </View>
                        </View>
                    </CardItem>
                </Card>
