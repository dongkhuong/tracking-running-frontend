        ...
        return (
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.6}}>
                    ...
                    <ScrollView horizontal={true} style={{marginTop: 0, backgroundColor: colors.white}}>
                        <View style={{height: metrics.DEVICE_HEIGHT*0.5}}>
                            <View style={{height: metrics.DEVICE_HEIGHT*0.18, width: metrics.DEVICE_HEIGHT*0.18, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5, marginTop: 5}}>
                                <Text>Run for healthy</Text>
                            </View>
                            <View style={{height: metrics.DEVICE_HEIGHT*0.18, width: metrics.DEVICE_HEIGHT*0.18, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5}}>
                                <Text>Run for healthy</Text>
                            </View>
                        </View>                        
                    </ScrollView>
