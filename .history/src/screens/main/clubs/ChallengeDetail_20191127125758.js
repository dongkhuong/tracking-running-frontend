...
class ChallengeDetail extends Component {
    ...
    render() {
        ...
        return(
            <ScrollView>
                <Text style={{textAlign: 'center', paddingVertical: 5, borderWidth:1, borderColor: colors.gray, fontWeight: 'bold'}}>Overview</Text>
                <View style={{paddingHorizontal: 20, paddingVertical: 20}}>
                    <HTML tagsStyles={{p: {textAlign: 'center', color: colors.darkGray, fontSize: 12}}} html={policy.overview} />
                </View>
                <Text style={{textAlign: 'center', paddingVertical: 5, borderWidth:1, borderColor: colors.gray, fontWeight: 'bold'}}>Rewards</Text>
                <View style={{paddingHorizontal: 20, paddingVertical: 20}}>
                    <HTML tagsStyles={{p: {textAlign: 'center', color: colors.darkGray, fontSize: 12}}} html={policy.rewards} />
                </View>
                <Text style={{textAlign: 'center', paddingVertical: 5, borderWidth:1, borderColor: colors.gray, fontWeight: 'bold'}}>Additional Info</Text>
                <View style={{paddingHorizontal: 20, paddingVertical: 20}}>
                    <HTML tagsStyles={{p: {textAlign: 'center', color: colors.darkGray, fontSize: 12}}} html={policy.add_infos} />
                </View>
                <Text style={{textAlign: 'center', paddingVertical: 5, borderWidth:1, borderColor: colors.gray, fontWeight: 'bold'}}>Rules</Text>
                <View style={{paddingHorizontal: 20, paddingVertical: 20}}>
