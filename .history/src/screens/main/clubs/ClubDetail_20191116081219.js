            ...
            <ScrollView
               ...
               {this.state.isShowButtonJoin ? (
                ...
                <View style={{flexDirection: 'row', flex:1, alignItems: 'center', paddingVertical: 10, backgroundColor: colors.white}}>
                    <View style={{flex: 1}}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('AddPost',{groupId: this.props.navigation.getParam('id')})} style={{borderRadius:2, paddingVertical: 8, alignItems: 'center', backgroundColor: colors.primaryColor, width: metrics.DEVICE_WIDTH*0.9}}>
