           ...
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View>
                    ...
                    <ScrollView horizontal={true}>
                        <View style={{backgroundColor: colors.white, height: metrics.DEVICE_HEIGHT*0.35, alignItems: 'center'}}>
                            <TouchableOpacity>
                                <View style={{height: metrics.DEVICE_HEIGHT*0.16, width: metrics.DEVICE_HEIGHT*0.16, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5, marginVertical: 5}}>
                                    <Image source={require('../../../assets/images/mapdemo.jpg')} resizeMode={'cover'} style={{height:'60%', width: '100%'}}/>
                                    <Text style={{fontSize: 11, textAlign: 'center'}}>Run for healthy</Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity>
                                <View style={{height: metrics.DEVICE_HEIGHT*0.16, width: metrics.DEVICE_HEIGHT*0.16, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5, marginVertical: 5}}>
