        ...
        return (
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{marginVertical: 10}}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("ViewAllClubs")} style={{borderColor: colors.darkGray, backgroundColor: colors.white, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 5, borderBottomWidth: 0.5, borderTopWidth: 0.5}}>
