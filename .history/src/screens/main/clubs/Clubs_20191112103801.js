           ...
           <ScrollView style={{backgroundColor: '#E7EAED'}}                     
            ...
            />   
               ...
               <View>
                    ...
                    <ScrollView horizontal={this.state.statusScrollView} style={{backgroundColor: colors.white}}>
                        {this.state.groups.map((item, index) => {
                            if(index % 2 == 0) {
                                this.setState({statusScrollView: true})
                            } else {
                                this.setState({statusScrollView: false})
                            }
                            return (
                                <TouchableOpacity>
