    ...
    render() {
        return (
            <ScrollView style={{backgroundColor: '#E7EAED'}}> 
               ...
               <View>
                    <ListItem
                        leftIcon={<Icon name="calendar" style={{width: 25}}/>}
                        titleStyle={{fontSize: 13 }}
                        title={"November 1, 2019 to November 30, 2019 - Nov 1, 2019 to Nov 30"}
                    />
                    <ListItem
                        leftIcon={<Icon name="walk" style={{width: 25}}/>}
                        titleStyle={{fontSize: 13}}
                        title={"Run 21.1 km"}
                    />
                    <ListItem
                        leftIcon={<Icon name="trophy" style={{width: 25}}/>}
                        titleStyle={{fontSize: 13}}
                ...
                <View>
                    <ListItem
                        leftAvatar={(props) => <Avatar source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8_hVrTLsijzhrN0mXMROFrTOSMVXxh5FlRK1S_-R5-7BbIX5N&s"}}/>}
