        ...
        return (
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{marginVertical: 10}}>
                    <TouchableOpacity style={{borderColor: colors.gray, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, borderBottomWidth: 1, borderTopWidth: 1}}>
