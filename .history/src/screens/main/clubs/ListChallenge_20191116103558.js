                ...
                <View style={{backgroundColor: colors.white}}>
                    <ListItem
                        ...
                        <View style={{marginTop: 5}}>
                            ...
                            <TouchableOpacity style={{borderWidth: 0.5, borderRadius:2, paddingVertical: 5, alignItems: 'center', color: colors.primaryColor, backgroundColor: colors.white, width: '100%'}}>
