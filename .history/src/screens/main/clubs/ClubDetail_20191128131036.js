               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.3}}>
                    <TouchableOpacity>
                        ...
                        {this.props.navigation.getParam('image') != null ?
                            <ImageBackground source={{ uri: "https://res.cloudinary.com/dccjf3l8c/image/upload/v1574920760/uploads/tmp/phpQT7d18.jpg" }} resizeMethod={'resize'} resizeMode={'cover'} style={{height: '100%', width: '100%'}}/>:
