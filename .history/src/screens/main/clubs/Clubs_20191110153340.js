           ...
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.2}}>
                    ...
                    <ScrollView horizontal={true} style={{backgroundColor: colors.white}} contentContainerStyle={{alignItems: 'center'}}>
                            <TouchableOpacity>
                                <View style={{height: metrics.DEVICE_HEIGHT*0.14, width: metrics.DEVICE_HEIGHT*0.14, alignItems: 'center', borderWidth: 0.5, borderColor: colors.darkGray, borderRadius: 5, marginHorizontal: 5, marginVertical: 5}}>
