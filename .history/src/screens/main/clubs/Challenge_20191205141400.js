            ...
            <ScrollView style={{backgroundColor: '#E7EAED'}}> 
               <View style={{height: metrics.DEVICE_HEIGHT*0.3}}>
                ...
                <View style={{paddingBottom: 10, alignItems: 'center', backgroundColor: colors.white}}>
                    ...
                    <HTML tagsStyles={{p: {textAlign: 'center', color: colors.darkGray, fontSize: 12}}} html={this.state.policy.overview} />    
                    : null}
                    </View>
               </View>
               <View>
                ...
                <View>
                    <ListItem
                        titleStyle={{textAlign: 'center', fontWeight: 'bold', color: colors.primaryColor}}
                        title={"TOP RANK"}
                    />
                    <ListItem
                        ...
                        leftElement={
                            <View style={{flexDirection: 'row'}}>
                                <Text style={{width: 50, textAlign: 'center', marginRight: 10, fontSize: 12, color: colors.darkGray}}>RANK</Text>
                                <Text style={{fontSize: 12, color: colors.darkGray}}>ATHLETE</Text>
                            </View>
                        }
                        rightElement={<Text style={{fontSize: 12, color: colors.darkGray}}>ELEVATION</Text>}
                    />
                    <ListItem
                        leftElement={
                            <View style={{flexDirection: 'row'}}>
                    ...
                    <ListItem
                        leftElement={
                            <View style={{flexDirection: 'row'}}>
                                <Text style={{width: 50, textAlign: 'center', marginRight: 10}}>3</Text>
                                <Text>Nguyen Huu Tuan</Text>
                            </View>
                        }
                        rightElement={<Text>8.1 km</Text>}
                    ...
                    <ListItem
                        leftElement={
                            <View style={{flexDirection: 'row'}}>
                                <Text style={{width: 50, textAlign: 'center', marginRight: 10}}>4</Text>
                                <Text>Nguyen Huu Tuan</Text>
                            </View>
                        }
                        rightElement={<Text>8.1 km</Text>}
                    ...
                    <ListItem
                        leftElement={
                            <View style={{flexDirection: 'row'}}>
                                <Text style={{width: 50, textAlign: 'center', marginRight: 10}}>5</Text>
                                <Text>Nguyen Huu Tuan</Text>
                            </View>
                        }
                        rightElement={<Text>8.1 km</Text>}
                    ...
                    <ListItem
                        leftElement={
                            <View style={{flexDirection: 'row'}}>
                                <Text style={{width: 50, textAlign: 'center', marginRight: 10}}>6</Text>
                                <Text>Nguyen Huu Tuan</Text>
                            </View>
                        }
                        rightElement={<Text>8.1 km</Text>}
