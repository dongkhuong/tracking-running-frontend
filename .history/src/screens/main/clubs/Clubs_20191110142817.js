    ...
    render() {
        return (
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.2}}>
                    <Text style={{marginHorizontal: 10,  marginTop: 2, fontWeight: 'bold', color: colors.darkGray}}>YOUR CLUBS</Text>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.5}}>
                    <Text style={{marginHorizontal: 10, marginTop: 2, fontWeight: 'bold', color: colors.darkGray}}>POPULAR NEAR YOU</Text>
                    <ScrollView horizontal={true} style={{backgroundColor: colors.white}}>
                        <View style={{height: metrics.DEVICE_HEIGHT*0.5}}>
