            ...
            <ScrollView 
                ...
                <View style={{backgroundColor: colors.white}}>
                    ...
                    <View style={{marginTop: 5}}>
                        <Text style={{fontSize: 12, color: colors.darkGray}}>{moment(String(item.end_date-item.start_date).toString()).fromNow(true)} left</Text>
                        <ProgressBarAndroid
                    ...
                    bottomDivider
                    onPress={() => this.props.navigation.navigate('Challenge',{challenge_id: item.id})}/>
                    ))
                    }      
                </View>
