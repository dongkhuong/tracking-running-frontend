    ...
    render() {
        return (
            <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.4, alignItems: 'center'}}>
                    ...
                    <View style={{flexDirection: 'row', flex: 1, height: metrics.DEVICE_HEIGHT*0.1, backgroundColor: 'red', borderBottomWidth: 1, borderColor: colors.darkGray, justifyContent: 'flex-end', alignItems:'flex-end'}}>
