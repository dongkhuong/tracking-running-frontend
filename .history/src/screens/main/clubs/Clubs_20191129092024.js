...
class Clubs extends Component {
    ...
    fetchDataPopularNearYou = async () => {
        ...
        // }
        const asyncStorage = await AsyncStorage.getItem("token")
        await axios.get(Constant.rootAPI+'/groups',{headers: {'Authorization': `Bearer ${asyncStorage}`}}).then(response => console.log(response)).catch(err=>console.log(err.response))
    }
