               ...
               <View>
                    ...
                    <ScrollView horizontal={true}>
                        <View style={{backgroundColor: colors.white, height: metrics.DEVICE_HEIGHT*0.35, justifyContent: 'center'}}>
                            <TouchableOpacity>
                                <View style={{height: metrics.DEVICE_HEIGHT*0.16, width: metrics.DEVICE_HEIGHT*0.16, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5, marginTop: 5}}>
                                    <Text>Run for healthy</Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity>
