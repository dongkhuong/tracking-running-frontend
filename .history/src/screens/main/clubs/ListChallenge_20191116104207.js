            ...
            <ScrollView style={{backgroundColor: '#E7EAED'}}> 
                ...
                <View style={{backgroundColor: colors.white}}>
                    <ListItem
                        ...
                        subtitle={
                        <View style={{marginTop: 5}}>
                            <Text style={{fontSize: 12, color: colors.darkGray}}>Run a 10k and shoot for a new PR asdasd mwqeqwe wqe sdf vsdvs df de dkjqwhkjehwqkjehkwqjehkjwqhkjbxcuhuishduihwqieuqwhewqeiuhiuh</Text>
