        ...
        return (
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.2}}>
                    ...
                    <ScrollView horizontal={true} style={{marginVertical: 5, backgroundColor: colors.white}}>
                        <View style={{height: metrics.DEVICE_HEIGHT*0.15, width: metrics.DEVICE_HEIGHT*0.15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5}}>
