               ...
               <View>
                    ...
                    <ScrollView horizontal={true}>
                        {/* <View style={{backgroundColor: colors.white, height: metrics.DEVICE_HEIGHT*0.35, justifyContent: 'center'}}> */}
                            <TouchableOpacity>
                                <View style={{backgroundColor: colors.white, height: metrics.DEVICE_HEIGHT*0.16, width: metrics.DEVICE_HEIGHT*0.16, alignItems: 'center', borderWidth: 0.5, borderColor: colors.gray, marginHorizontal: 5, marginVertical: 5}}>
                                    <Image source={require('../../../assets/images/mapdemo.jpg')} resizeMode={'cover'} style={{height:'60%', width: '100%'}}/>
