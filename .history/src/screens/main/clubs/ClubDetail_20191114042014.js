        ...
        return (
            <ScrollView
               ...
               {this.state.isShowButtonJoin ? (
                ...
                <View style={{alignItems: 'center', paddingVertical: 10, backgroundColor: colors.white}}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('AddPost')} style={{borderRadius:2, paddingVertical: 8, alignItems: 'center', backgroundColor: colors.primaryColor, width: metrics.DEVICE_WIDTH*0.9}}>
