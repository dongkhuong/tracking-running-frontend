               ...
               <View>
                    ...
                    <ScrollView horizontal={true} style={{backgroundColor: colors.white}}>
                        {this.state.groups.map((item, index) => {
                            return (
                                <TouchableOpacity>
                                    <View style={{ height: metrics.DEVICE_HEIGHT*0.3, width: metrics.DEVICE_HEIGHT*0.3, alignItems: 'center', borderWidth: 0.5, borderColor: colors.gray, marginHorizontal: 5, marginVertical: 5}}>
                                        <Image source={require('../../../assets/images/mapdemo.jpg')} resizeMode={'cover'} style={{height:'60%', width: '100%'}}/>
