    ...
    render() {
        return (
            <ScrollView style={{backgroundColor: '#E7EAED'}}> 
                ...
                <View style={{backgroundColor: colors.white}}>
                    <ListItem
                        leftElement={<Image style={{width: 90, height: 90}} source={{uri: 'https://helpx.adobe.com/content/dam/help/en/stock/how-to/visual-reverse-image-search/jcr_content/main-pars/image/visual-reverse-image-search-v2_intro.jpg'}}/>}
                        titleStyle={{fontSize: 13 }}
                        title={"November Half Marathon Challenge"}
                        subtitle={
                        <View style={{marginTop: 5}}>
