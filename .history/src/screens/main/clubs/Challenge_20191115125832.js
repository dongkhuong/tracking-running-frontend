    ...
    render() {
        return (
            <ScrollView style={{backgroundColor: '#E7EAED'}}> 
               ...
               <View>
                    <ListItem
                        leftIcon={<Icon name="calendar" style={{width: 25, alignItems: 'center', justifyContent: 'center'}}/>}
                        titleStyle={{fontSize: 13 }}
                        title={"November 1, 2019 to November 30, 2019 - Nov 1, 2019 to Nov 30"}
                        bottomDivider
                    />
                    <ListItem
                        leftIcon={<Icon name="walk" style={{width: 25, alignItems: 'center', justifyContent: 'center'}}/>}
                        titleStyle={{fontSize: 13}}
                        title={"Run 21.1 km"}
                        bottomDivider
                    />
