               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.3}}>
                    <TouchableOpacity>
                        ...
                        {this.props.navigation.getParam('image') != null ?
                            <Image source={{ uri: this.props.navigation.getParam('image')}} resizeMethod={'scale'} resizeMode={'cover'} style={{height: '100%', width: '100%'}}/>:
                            <Image source={require('../../../assets/images/mapdemo.jpg')} resizeMethod={'scale'} resizeMode={'cover'} style={{height: '100%', width: '100%'}}/>}
                    </TouchableOpacity>
               </View>
