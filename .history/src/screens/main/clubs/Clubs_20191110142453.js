    ...
    render() {
        return (
           <ScrollView style={{backgroundColor: '#E7EAED'}}>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.2}}>
                    <Text style={{marginHorizontal: 10, marginVertical: 5, marginTop: 2, fontWeight: 'bold', color: colors.darkGray}}>YOUR CLUBS</Text>
                    <ScrollView horizontal={true} style={{backgroundColor: colors.white}}>
                        ...
                        <View style={{height: metrics.DEVICE_HEIsGHT*0.15, width: metrics.DEVICE_HEIGHT*0.15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5, marginVertical: 5}}>
                            <Text>Run for healthy</Text>
                        </View>
                        <View style={{height: metrics.DEVICE_HEIGHT*0.15, width: metrics.DEVICE_HEIGHT*0.15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5, marginVertical: 5}}>
                            <Text>Run for healthy</Text>
               ...
               <View style={{height: metrics.DEVICE_HEIGHT*0.6}}>
                    <Text style={{marginHorizontal: 10, marginVertical: 5, marginTop: 2, fontWeight: 'bold', color: colors.darkGray}}>POPULAR NEAR YOU</Text>
                    <ScrollView horizontal={true} style={{backgroundColor: colors.white}}>
                        ...
                        <View style={{height: metrics.DEVICE_HEIGHT*0.5}}>
                                <TouchableOpacity style={{height: metrics.DEVICE_HEIGHT*0.17, width: metrics.DEVICE_HEIGHT*0.17, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginHorizontal: 5, marginTop: 5}}>
                                    <View >
                                        <Text>Run for healthy</Text>
                                    </View>
                                </TouchableOpacity>
