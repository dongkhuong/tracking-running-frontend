            ...
            <ScrollView
               ...
               {this.state.isShowButtonJoin ? (
                ...
                <View style={{flexDirection: 'row', flex:1, alignItems: 'center', paddingVertical: 10, backgroundColor: colors.white}}>
                    ...
                    <View style={{flex: 1, alignItems: 'center'}}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('Challenge',{groupId: this.props.navigation.getParam('id')})} style={{borderRadius:2, paddingVertical: 8, alignItems: 'center', backgroundColor: "orange", width: '90%'}}>
