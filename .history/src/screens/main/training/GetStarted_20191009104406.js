            ...
            <View style={{flex: 1}}>
                <ImageBackground source={require('../../../assets/images/getstarted2.jpeg')} style={{width: metrics.DEVICE_WIDTH, height: metrics.DEVICE_HEIGHT}} resizeMode={'stretch'}>
                    ...
                    <View style={{alignItems: 'center', justifyContent: 'center', flex: 5}}>
                        ...
                        <Text style={[{textAlign: 'center', paddingHorizontal:20, lineHeight: 15}, styles.titleSmall]}>Help us get to know you and your goals better. That way we can craft a Premium Training Plan to get you there!</Text>
                    </View>
                </ImageBackground>
            </View>
        );
