                        ...
                        <Card>
                            <CardItem style={styles.resetPadding}>
                                <ImageBackground style={styles.imageBackground} source={require('../../../assets/images/backgroundImage.jpg')}>
                                    ...
                                    <TextPage color={colors.white} fontSize={fonts.fontCardSmall} fontWeight={'500'}>Learn the basics of running</TextPage>
                                    <TextPage color={colors.white} fontSize={fonts.fontCardSmall} fontWeight={'500'}>(6 - 10 weeks)</TextPage>
                                </ImageBackground>
                            </CardItem>
                            <CardItem style={styles.resetPadding}>
                                <ImageBackground style={styles.imageBackground} source={require('../../../assets/images/backgroundImage.jpg')}>
