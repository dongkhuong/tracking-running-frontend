        ...
        return (
            <View style={{flex: 1}}>
                <ImageBackground source={require('../../../assets/images/getstarted2.jpeg')} style={{width: metrics.DEVICE_WIDTH, height: metrics.DEVICE_HEIGHT}} resizeMode={'stretch'}>
                    ...
                    <View style={{alignItems: 'center', flex:3, width: metrics.DEVICE_WIDTH*0.8, backgroundColor: 'blue'}}>
                        <TouchableOpacity style={{width: metrics.DEVICE_WIDTH*0.8, alignItems: 'center'}}>
