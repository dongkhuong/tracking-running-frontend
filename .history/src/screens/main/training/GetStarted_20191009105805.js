            ...
            <View style={{flex: 1}}>
                <ImageBackground source={require('../../../assets/images/getstarted2.jpeg')} style={{width: metrics.DEVICE_WIDTH, height: metrics.DEVICE_HEIGHT}} resizeMode={'stretch'}>
                    ...
                    <View style={{alignItems: 'center', flex:3}}>
                        <TouchableOpacity style={{width: metrics.DEVICE_WIDTH*0.8, alignItems: 'center', backgroundColor: colors.primaryColor, paddingVertical: 10, borderRadius: metrics.DEVICE_WIDTH*0.5}}>
