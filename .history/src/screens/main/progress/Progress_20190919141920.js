        ...
        return (
            <ScrollView style={styles.scrollContainer}>
                <ImageBackground resizeMode={'cover'} style={styles.progressImageHeader} source={require('../../../assets/images/backgroundImage.jpg')}>
                    ...
                    <TextPage color={colors.white} fontSize={fonts.fontIntroProgressMedium}>Nothing feels better than setting a personal goal and celebrating your success when you achieve it!</TextPage>
                </ImageBackground>
            </ScrollView>
        )
    }
