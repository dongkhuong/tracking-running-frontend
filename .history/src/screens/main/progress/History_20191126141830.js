                                ...
                                {this.state.activities.length > 0 ? (
                                    <CardItem style={{flexDirection:'row', flex: 1}}>
                                        <Body style={{alignItems: 'center'}}>
                                            <Text style={{textAlign: 'center', color: colors.primaryColor, fontWeight: 'bold'}}>{this.state.activities.length > 1 ? this.state.activities.length + " activities" : this.state.activities.length + " activity"}</Text>               
                                        </Body> 
                                    </CardItem>
                                    ): 
                                    <CardItem style={{flexDirection:'row', flex: 1}}>
