                ...
                refreshControl = {
                    ...
                    <Content>
                        ...
                        <Card>
                            ...
                            <CardItem style={styles.cardItemAdd}>
                                <TouchableOpacity style={{ flexDirection: 'row' , alignItems: 'center'}} onPress={() => this.props.navigation.navigate('AddManualEntry')}>
                                    <Icon name="add-circle-outline" color={colors.primaryColor} style={{marginRight: 10, borderColor: colors.primaryColor}}/>
                        ...
                        <Card>
                            ...
                            <CardItem style={styles.cardItemAdd}>
                                <TouchableOpacity style={{ flexDirection: 'row' , alignItems: 'center'}} onPress={() => this.props.navigation.navigate('AddGoal')}>
                                    <Icon name="add-circle-outline" color={colors.primaryColor} style={{marginRight: 10, borderColor: colors.primaryColor}}/>
