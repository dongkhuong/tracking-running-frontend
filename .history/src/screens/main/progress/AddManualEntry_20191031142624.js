...
class AddManualEntry extends Component {
    ...
    handleTimePicked = time => {
        ...
        const start_time = String.toString(time)
        console.log("A Time has been picked:" + start_time)
    }
                ...
                <Content>
                    ...
                    <Card>
                        <TouchableOpacity onPress={() => this.showModalDuration()}>
                            <Select nameIcon='stopwatch' title="Durian" value={duration ? duration : '00:00:00'} />
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity onPress={() => this.showTimePicker()}>
                            <Select nameIcon='time' title="Time" value={time? time: new Date().getHours()+ ':'+ new Date().getMinutes() + ':' + new Date().getSeconds() } />
                        </TouchableOpacity>
                    </Card>
                    <DateTimePicker
