...
import { NavigationStackAction, NavigationAction } from 'react-navigation'
const resetAction = NavigationStackAction.reset({
    index: 0,
    actions: [NavigationAction.navigate({ routeName: 'NewsFeed' })],
});
