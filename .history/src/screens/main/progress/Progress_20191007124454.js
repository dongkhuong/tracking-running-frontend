            ...
            <Container>
                <ScrollView style={styles.scrollContainer}>
                    <Content>
                        <Card>
                            <CardItem>
                                <Text style={{fontWeight: 'bold', fontFamily: 'Mansalva-Regular'}}>CHALLENGES</Text>
                            </CardItem>
                        </Card>
                        <Card>
                            <CardItem style={{flexDirection:'row', flex: 1}}>
                                <Text style={{fontWeight: 'bold', flex: 1}}>RECENT ACTIVITIES</Text>
                            ...
                            <CardItem style={styles.cardItemAdd}>
                                <TouchableOpacity>
                                    <Text style={{color: colors.primaryColor,  fontFamily: 'Mansalva-Regular'}}>ADD AN ACTIVITY MANUALLY</Text>
                                </TouchableOpacity>
                            </CardItem>
                        </Card>
                        <Card>
