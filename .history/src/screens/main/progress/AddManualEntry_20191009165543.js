        ...
        return (
            <Container>
                <Content>
                    ...
                    mode="time"
                    />
                    <Modal isVisible={this.state.isModalVisible} style={{backgroundColor: 'white', height: metrics.DEVICE_HEIGHT*0.2, width: metrics.DEVICE_WIDTH*0.8, alignItems: 'center'}}>
                        <View style={{ flex: 1 }}>
                            <Text>Hello!</Text>
