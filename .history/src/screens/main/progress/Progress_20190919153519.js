                ...
                <Card>
                    <CardItem>
                        <Left>
                            ...
                            <Body>
                                <TouchableOpacity>
                                    <TextPage color={colors.white} fontSize={13} fontWeight={300}>Unlock All Features</TextPage>
                                    <TextPage color={colors.yellow} fontSize={13} fontWeight={300}>GET PREMIUM</TextPage>
                                </TouchableOpacity>
                            </Body>
                        </Left>
                    </CardItem>
