    ...
    render() {
        ...
        return (
            <ScrollView style={styles.scrollContainer}>
                ...
                <Card title="RECENT ACTIVITIES" containerStyle={{ paddingVertical: 0}}>
                    <TouchableOpacity>
                        <TextPage color={colors.blue} fontSize={fonts.fontIntroProgressMedium}>ADD AN ACTIVITY MANUALLY</TextPage>
                    </TouchableOpacity>
                </Card>
            </ScrollView>
        )
