...
class History extends Component {
    ...
    async componentDidMount () {
        try{
            ...
            const activities = await axios.get(Constant.rootAPI+'/getActivityByWeek/'+40,
            {headers: {'Authorization': `Bearer ${asyncStorage}`}})
            this.setState({activities: activities.data.data})
    ...
    getActivityByWeek = async (id) => {
        const activities = await axios.get(Constant.rootAPI+'/getActivityByWeek/'+id,
        {headers: {'Authorization': `Bearer ${asyncStorage}`}})
        this.setState({activities: activities.data.data})
        return (
