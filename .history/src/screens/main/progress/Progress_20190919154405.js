                    ...
                    <CardItem>
                        <Left>
                            ...
                            <TouchableOpacity style={{flex: 1, marginLeft:10}}>
                                <TextPage color={colors.blue} fontSize={13} fontWeight={'bold'}>Unlock All Features</TextPage>
                                <TextPage color={colors.orange} fontSize={13} fontWeight={'bold'} marginVertical={'10'}>GET PREMIUM</TextPage>
                            </TouchableOpacity>
                        </Left>
                    </CardItem>
                </Card>
