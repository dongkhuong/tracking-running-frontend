                    ...
                    <Content>
                        ...
                        <Card>
                            <CardItem style={{flexDirection:'row', flex: 1}}>
                                <Text style={{ fontFamily: 'Montserrat-Regular'}}>THAI DONGKHUONG</Text>
                        ...
                        <Card>
                            <CardItem>
                                <Text style={{ fontFamily: 'Montserrat-Regular'}}>STATISTICS</Text>
                            </CardItem>
                            <CardItem>
                                    <Text style={{ fontFamily: 'Montserrat-Regular'}}>Thống kê tại đây</Text>
                            </CardItem>
                        </Card>
                        <Card>
                            <CardItem>
