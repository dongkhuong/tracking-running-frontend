...
class AddManualEntry extends Component {
    ...
    handleDatePicked = date => {
        ...
        console.log(date)
        const start_date = String(date).substring(4,7)
        console.log(moment().month(start_date).format("MM"))
    }
                ...
                <Content>
                    ...
                    <Card>
                        ...
                        <TouchableOpacity onPress={() => this.showTimePicker()}>
                            <Select nameIcon='time' title="Time" value={time? time: new Date().getHours()+ ':'+ new Date().getMinutes('mm') + ':' + new Date().getSeconds() } />
                        </TouchableOpacity>
                    </Card>
                    <DateTimePicker
