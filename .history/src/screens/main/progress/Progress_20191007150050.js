                ...
                <ScrollView style={styles.scrollContainer}>
                    <Content>
                        ...
                        <Card>
                            <CardItem style={{flexDirection:'row', flex: 1}}>
                                ...
                                <TouchableOpacity style={{flex: 1, alignItems: 'flex-end'}}>
                                    <Text style={{color: colors.primaryColor, fontWeight: 'bold', fontStyle: 'italic'}}>SHOW MORE</Text>
                                </TouchableOpacity>
                            </CardItem> 
                            <CardItem style={styles.cardItemAdd}>
                                <TouchableOpacity>
                                    <Text style={{color: colors.primaryColor, fontWeight: 'bold', fontStyle: 'italic'}}>ADD AN ACTIVITY MANUALLY</Text>
                                </TouchableOpacity>
                            </CardItem>
                        </Card>
                        <Card>
                        ...
                        <Card>
                            ...
                            <CardItem style={styles.cardItemAdd}>
                                <TouchableOpacity>
                                    <Text style={{color: colors.primaryColor, fontWeight: 'bold', fontStyle: 'italic'}}>ADD GOAL</Text>
                                </TouchableOpacity>
                            </CardItem>
                        </Card>
                    </Content>
