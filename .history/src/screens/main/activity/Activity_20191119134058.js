                    ...
                    <View style={{flexDirection: 'row', width: metrics.DEVICE_WIDTH, justifyContent: 'center' }}>
                        ...
                        (
                          ...
                          }}>           
                          {
                            ...
                            <TouchableOpacity disabled={false} onPress={this.toggleStopwatch} style={{flex: 1, alignItems: 'center', backgroundColor: colors.green, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
                              <Text style={{color: colors.white, fontWeight: 'bold', fontSize: 18}}>RESUME</Text>
                            </TouchableOpacity> :
                            <TouchableOpacity disabled={false} onPress={this.toggleStopwatch} style={{flex: 1, alignItems: 'center', backgroundColor: colors.yellow, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
