                  ...
                  <View style={styles.container}>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <View style={
                          ...
                          <View style={{width: 40, height: 40, borderRadius: 20, backgroundColor: colors.white, position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center'}}></View>
                        </View> 
