                    ...
                    <ImageBackground source={require('../../../assets/images/mapdemo.jpg')} style={{width: metrics.DEVICE_WIDTH, height: metrics.DEVICE_HEIGHT*0.5}}>
                        <View style={{alignItems: 'center', flex: 1}}>
                            <View style={{flexDirection: 'row'}}>
                                <TouchableOpacity style={{width: metrics.DEVICE_WIDTH*0.1, alignItems: 'center', marginTop: metrics.DEVICE_HEIGHT*0.3, backgroundColor: colors.primaryColor, borderRadius: metrics.DEVICE_WIDTH*0.1, paddingVertical: 2}}>
                                </TouchableOpacity>
                                ...
                                <TouchableOpacity style={{width: metrics.DEVICE_WIDTH*0.1, height: metrics.DEVICE_WIDTH*0.1, alignItems: 'center', marginTop: metrics.DEVICE_HEIGHT*0.3, backgroundColor: colors.primaryColor, borderRadius: metrics.DEVICE_WIDTH*0.05, paddingVertical: 2}}>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </ImageBackground>    
