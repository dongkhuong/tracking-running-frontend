                    ...
                    <View style={{flexDirection: 'row', width: metrics.DEVICE_WIDTH, justifyContent: 'center' }}>
                        ...
                        (
                          ...
                          }}>           
                          {
                            ...
                            <TouchableOpacity disabled={true} onPress={this.toggleStopwatch} style={{flex: 1, alignItems: 'center', backgroundColor: colors.green, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
                        ...
                        {
                          !this.state.isShowButtonStart ? 
                          <View style={{width: 40, height: 40, borderRadius: 20, backgroundColor: colors.white, position: 'absolute', bottom: 18}}></View>
                          : null
                        }                            
                    </View>
                  </View>
