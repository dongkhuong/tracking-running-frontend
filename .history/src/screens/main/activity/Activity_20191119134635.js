              ...
              <View style={{flex: 2}}>
                  <View style={styles.container}>
                    ...
                    <View style={{flexDirection: 'row', width: metrics.DEVICE_WIDTH, justifyContent: 'center' }}>
                        ...
                        {
                          !this.state.isShowButtonStart ? 
                          <TouchableHighlight onPress={() => this.setState({disableButton: !this.state.disableButton})} style={{width: 40, height: 40, borderRadius: 20, backgroundColor: colors.white, position: 'absolute', bottom: 18, justifyContent: 'center', alignContent: 'center'}}>
                              <Icon name="lock" color={colors.black}/>
                          </TouchableHighlight>
                          : null
                        }                            
                    </View>
