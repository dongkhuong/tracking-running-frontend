           ...
           <View style={{flex: 1}}>
              <View style={{flex:1, borderBottomWidth: 1, borderBottomColor: colors.darkGray}}>
                <TouchableOpacity style={{height: 'auto', alignItems: 'center', paddingBottom: 20}}>
                    <Image source={require('../../../assets/images/runer-silhouette-running-fast.png')} style={{marginTop: 10, width:50, height: 50}}/>
                    <View  style={{alignItems: 'center', marginBottom: 5}}>
                        <Text style={{fontSize: 25, fontWeight: 'bold'}}>{parseFloat(this.state.distanceTravelled).toFixed(2)} km</Text>
                        <Text style={{fontSize: 15}}>Distance</Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                        <Left style={{alignItems: 'center'}}>
              ...
              <View style={{flex: 2}}>
                  <View style={styles.container}>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <TouchableOpacity style={[styles.ovanButton, !this.state.stopwatchStart ? null: styles.changeBackgroundStatus]} onPress={this.toggleStopwatch}s>
                            <Text style={{color: colors.white, fontWeight: 'bold', fontSize: 20,}}>{!this.state.stopwatchStart ? "START" : "STOP"}</Text>
                        </TouchableOpacity>
                    </View>
                  </View>
              </View>
