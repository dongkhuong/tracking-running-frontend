...
class Activity extends Component {
    ...
    render() {
        const { ready, latitude, longitude, positions } = this.state
        if(!ready) {
            return (
            ...
            <View style={{flex: 1}}>
                ...
                <View style={{flex: 2}}>
                 <MapView
                    ...
                    <Polyline coordinates={[{latitude:16.054407, longitude: 108.202164, latitudeDelta: LATITUDE_DELTA, longitudeDelta: LONGITUDE_DELTA},{latitude: 15.509470,longitude: 107.975212}]} strokeWidth={10} strokeColor="#f2b659"/>
