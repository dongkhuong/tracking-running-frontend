        ...
        {text: 'Yes', onPress: () => {
          if(this.state.duration != null)
          {
              ...
              if(this.state.distanceTravelled != 0){
                ...
                this.setState({averagePace: averagePace, averageSpeed: averageSpeed})
                console.log(this.calcCalories(this.state.gender, this.state.age, this.state.height, this.state.weight, timeDecimal, this.state.averageSpeed))
                // console.log(timeDecimal + '///' + averagePaceDecimal + "///"+ averagePace + "///" + averageSpeed)
  ...
  async componentDidMount() {
    ...
    if(asyncStorage) {
        ...
        .then(({data}) => {
          ...
          console.log(this.state.gender+ '///' + this.state.height + '///' + this.state.age)
        })
