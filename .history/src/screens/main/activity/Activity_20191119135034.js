                    ...
                    <View style={{flexDirection: 'row', width: metrics.DEVICE_WIDTH, justifyContent: 'center' }}>
                        ...
                        (
                          ...
                          }}>           
                          {
                            ...
                            <TouchableOpacity disabled={this.state.disableButton} onPress={this.toggleStopwatch} style={{flex: 1, alignItems: 'center', backgroundColor: colors.green, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
                              <Text style={{color: colors.white, fontWeight: 'bold', fontSize: 18}}>RESUME</Text>
                            </TouchableOpacity> :
                            <TouchableOpacity disabled={this.state.disableButton} onPress={this.toggleStopwatch} style={{flex: 1, alignItems: 'center', backgroundColor: colors.yellow, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
                              <Text style={{color: colors.white, fontWeight: 'bold', fontSize: 18}}>PAUSE</Text>
                            </TouchableOpacity>
                          }
                              <TouchableOpacity disabled={this.state.disableButton} style={{flex: 1, alignItems: 'center', backgroundColor: colors.red, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
                        ...
                        {
                          !this.state.isShowButtonStart ? 
                          <TouchableHighlight onPress={() => this.setState({disableButton: !this.state.disableButton})} style={{width: 40, height: 40, borderRadius: 20, backgroundColor: colors.white, position: 'absolute', bottom: 18, justifyContent: 'center', alignItems: 'center'}}>
                              {
                              this.state.disableButton ? 
                              <Icon name="lock" color={colors.darkGray}/>
                              :
                              <Icon name="lock" color={colors.darkGray}/>
                              }   
                          </TouchableHighlight>
