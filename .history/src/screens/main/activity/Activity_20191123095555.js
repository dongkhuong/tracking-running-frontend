        ...
        {text: 'Yes', onPress: () => {
          if(this.state.duration != null)
          {
              ...
              if(this.state.distanceTravelled != 0){
                ...
                console.log(this.state.averagePace + ',,,' + this.state.averageSpeed + ',,,' +this.state.calories+ ',,,'+ this.state.startTime+',,,'+this.state.date)
              } else {
                this.setState({averagePace: "00:00", averageSpeed: 0, distance: 0, calories: 0})
