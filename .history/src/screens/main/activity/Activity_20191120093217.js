...
class Activity extends React.Component {
  ...
  async finishActivity() {
    ...
    Alert.alert(
      'Finish',
      'Are you sure to finish this activity?',
      [
        {text: 'Yes', onPress: () => {
          this.setState({duration: this.currentTime})
              ...
              <View style={{flex:1, borderBottomWidth: 1, borderBottomColor: colors.gray}}>
                <TouchableOpacity onPress={() => this.setState({isClickScreen: !this.state.isClickScreen})} style={{height: 'auto', alignItems: 'center', paddingBottom: 20}}>
                    ...
                    <View style={{alignItems: 'center'}}>
                      ...
                      <View style={{alignItems: 'center'}}>
                        <Image source={require('../../../assets/images/runer-silhouette-running-fast.png')} style={{marginTop: 10, width:30, height: 30}}/>
                      </View> 
                     )
                    } 
                    <View style={{flexDirection: 'row', marginTop: this.state.isClickScreen === true ? 10: 0}}>
