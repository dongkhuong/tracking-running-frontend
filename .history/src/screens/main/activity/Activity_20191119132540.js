                  ...
                  <View style={styles.container}>
                    ...
                    <View style={{flexDirection: 'row', width: metrics.DEVICE_WIDTH, justifyContent: 'center' }}>
                        ...
                        <View
                          ...
                          <TouchableOpacity onPress={this.actionChangeButton} style={{width: metrics.DEVICE_WIDTH*0.8, flex: 1, alignItems: 'center', backgroundColor: colors.primaryColor, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
                        ...
                        //     flexDirection: 'row'
                        //   }}>                 
                        //       <TouchableOpacity style={{flex: 1, alignItems: 'center', backgroundColor: colors.green, borderRadius: metrics.DEVICE_WIDTH*0.25, paddingVertical: 5}}>
