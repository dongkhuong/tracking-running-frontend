    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={{flex: 1}}>
                    <ImageBackground source={require('../../../assets/images/mapdemo.jpg')} style={{width: metrics.DEVICE_WIDTH, height: metrics.DEVICE_HEIGHT*0.5, justifyContent: 'flex-end'}}>
                        <View style={{alignItems: 'center'}}>
                            <TouchableOpacity style={{width: metrics.DEVICE_WIDTH*0.5, alignItems: 'center', backgroundColor: 'blue'}}>
