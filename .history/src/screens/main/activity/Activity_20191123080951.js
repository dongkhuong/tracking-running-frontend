...
class Activity extends React.Component {
        ...
        {text: 'Yes', onPress: () => {
          if(this.state.duration != null)
          {
              ...
              if(this.state.distanceTravelled != 0){
                ...
                let averagePace = moment().startOf('day').add(averagePaceDecimal, 'hours').format('HH:mm')
  ...
  async componentDidMount() {
    ...
    if(asyncStorage) {
        ...
        .then(({data}) => {
          this.setState({height: data.data.height, weight: data.data.weight, gender: data.data.gender})
          console.log(this.state.gender+ '///' + this.state.height)
        })
