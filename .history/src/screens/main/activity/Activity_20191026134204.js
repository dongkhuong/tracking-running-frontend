...
class Activity extends React.Component {
  ...
  // formularForAveragePace = (distance, duration) => {
           ...
           <View style={{flex: 1}}>
              ...
              <View style={{flex: 2}}>
                  <View style={styles.container}>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <TouchableOpacity style={[styles.ovanButton, !this.state.stopwatchStart ? null: styles.changeBackgroundStatus]} onPress={this.toggleStopwatch}>
