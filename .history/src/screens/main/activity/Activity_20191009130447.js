                ...
                <View style={{flex: 1}}>
                    <ImageBackground source={require('../../../assets/images/mapdemo.jpg')} style={{width: metrics.DEVICE_WIDTH, height: metrics.DEVICE_HEIGHT*0.5}}>
                        <View style={{alignItems: 'center', flex: 0.5}}>
                            <TouchableOpacity style={{width: metrics.DEVICE_WIDTH*0.5, alignItems: 'center', marginTop: metrics.DEVICE_HEIGHT*0.3, backgroundColor: 'blue', borderRadius: metrics.DEVICE_WIDTH*0.25}}>
