...
export default class UploadImage extends Component {
    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                {
                    this.state.avatarSource && <Image source={{ uri: "https://res.cloudinary.com/dccjf3l8c/image/upload/v1575012401/cqpnal6xay6xdrxmyjgw.jpg" }} style={{ width: '80%', height: 200, resizeMode: 'contain' }} />
                }
                {
