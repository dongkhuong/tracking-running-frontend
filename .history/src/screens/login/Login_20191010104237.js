    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View>
                    <TouchableOpacity style={{paddingVertical: 10, backgroundColor: colors.primaryColor, width: metrics.DEVICE_WIDTH*0.85, alignItems: 'center', marginRight: 20, marginLeft: 20}}>
                        <Text>LOGIN</Text>
                    </TouchableOpacity>
                </View>
                </View>
