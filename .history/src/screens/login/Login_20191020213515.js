    ...
    _signInAsync = async () => {
        if(this.state.email!='' && this.state.password!='') {
            ...
            .then(async (response) => {
                ...
                AsyncStorage.setItem('currentUser',JSON.stringify(response.data.data.user.email))
                AsyncStorage.getItem('token').then(values => console.log(values))
                AsyncStorage.getItem('currentUser').then(values => console.log(values))
            })
