    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View>
                    <TouchableOpacity style={{paddingVertical: 10, backgroundColor: colors.primaryColor, width: metrics.DEVICE_WIDTH*0.85, alignItems: 'center', borderRadius: 5, marginTop: 20}}>
