    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View>
                    <TouchableOpacity style={{paddingVertical: 10, backgroundColor: colors.primaryColor, width: metrics.DEVICE_WIDTH*0.9, alignItems: 'center', marginRight: 10, marginLeft: 10}}>
                        <Text>LOGIN</Text>
                    </TouchableOpacity>
                </View>
                </View>
