...
const MaterialBottomTabNavigator = createMaterialBottomTabNavigator({
    ...
    Progress: {
        ...
        navigationOptions: {
            ...
            tabBarIcon: ({focused}) => (
                <Icon name="progress" color={focused ? colors.primaryColor : colors.inActiveColorBottom}/>
            )
        }
    },
    Activity: {
    ...
    Profile: {
        ...
        navigationOptions: {
            tabBarLabel: 'Profile',
            tabBarIcon: ({focused}) => (
                <Icon name="account-circle" color={focused ? colors.primaryColor : colors.inActiveColorBottom}/>
            )
        }
    }
