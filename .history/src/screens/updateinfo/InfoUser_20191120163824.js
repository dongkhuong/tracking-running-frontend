        ...
        return (
            <View style={{flex: 1}}>
                ...
                <TouchableOpacity style={{paddingHorizontal: 10}}>
                    <View style={{width: metrics.DEVICE_WIDTH*0.85, backgroundColor: 'red', paddingVertical: 5, paddingHorizontal: 20, borderBottomWidth: 2, borderBottomColor: colors.darkGray}}>
