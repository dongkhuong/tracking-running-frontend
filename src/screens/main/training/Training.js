...
import { Text, ImageBackground, ScrollView, TouchableOpacity } from "react-native"
                    ...
                    <Content>
                        <Card>
                            {this.renderSection().map(( item ) => (
                                <TouchableOpacity key={item.id} onPress={() => this.props.navigation.navigate('GetStarted')}>
